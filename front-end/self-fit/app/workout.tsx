...
const styles = StyleSheet.create({
  ...
  colIdx: { color: colors.grayMid, fontSize: 11, fontWeight: 'bold', width: 44, textAlign: 'center' },
  colLabel: { flex: 1, color: colors.grayMid, fontSize: 11, fontWeight: 'bold', textAlign: 'center' },
  colCheck: { width: 48, color: colors.grayMid, fontSize: 11, fontWeight: 'bold', textAlign: 'center' },
  seriesRow: {
    flexDirection: 'row', alignItems: 'center',
    paddingVertical: 10, borderRadius: 10, marginBottom: 4,
    paddingHorizontal: 2,
  },
  seriesRowDone: { backgroundColor: '#0A1A0A' },
  seriesIdx: { color: colors.white, width: 44, fontWeight: 'bold', textAlign: 'center', fontSize: 16 },
  textDone: { color: '#4CAF50' },
  seriesInput: {
    flex: 1, height: 44, backgroundColor: '#1A1A1A', color: colors.white,
    borderRadius: 8, textAlign: 'center', fontSize: 18, fontWeight: '700',
    marginHorizontal: 4,
  },
