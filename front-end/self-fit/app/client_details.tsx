...
export default function ClientDetails() {
  ...
  // CORREÇÃO: Agora lendo 'id' para bater com a navegação da clients.tsx
  ...
  const handleDesvincular = () => {
    Alert.alert(
      "Desvincular Aluno",
      `Tem certeza que deseja remover ${student?.nome} da sua lista de alunos?`,
      [
        ...
        { 
          ...
          onPress: async () => {
            try {
              await api.delete(`/professor/desvincular-aluno/${id}`);
              Alert.alert("Sucesso", "Aluno desvinculado com sucesso.");
              router.back();
            } catch (e) {
              Alert.alert("Erro", "Não foi possível desvincular o aluno.");
            }
          }
        }
      ]
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.menuGrid}>
          ...
          <TouchableOpacity 
            style={[styles.menuItem, { marginTop: 20, borderColor: 'rgba(255,0,0,0.2)' }]} 
          ...
          >
            ...
            <Text style={[styles.menuLabel, { color: colors.red }]}>Desvincular Aluno</Text>
